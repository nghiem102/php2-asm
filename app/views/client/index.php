        ...
        <section class="m-4">
            <div class="row">
                <div class="alert alert-success col-12" role="alert">
                    <h4 class="alert-heading"> Danh sách môn học</h4>
                </div>
            </div>
            <div class="row">
                ...
                <?php foreach ($subject as $item) : ?>
                    <div class="card col-6">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted"> <?= $item->count_quiz ?> quiz</h6>

                            <a href="<?= BASE_URL ?>client-quiz?subject_id=<?= $item->id ?>" class="card-link btn btn-primary">Làm quiz</a>
                        </div>
                    </div>
                <?php endforeach ?>
            </div>
